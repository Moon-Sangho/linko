---
name: vitest
description: Vitest - Modern TypeScript testing framework with Vite-native performance, ESM support, and TypeScript-first design. Use when setting up testing infrastructure, writing unit/component tests, or migrating from Jest.
license: MIT
metadata:
...
const createTestConfig = <const T extends Record<string, unknown>>(
  config: T,
): T => config;
